            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title pt-2">Category Table</h3>

                  <div class="float-right">
                    <a type="submit" href="/admin/insertCategory" class="btn btn-primary text-light ">Insert</a>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $note = $db->query("SELECT * from category")->get();
                      $i = 0;
                      while (true) {
                        if (!isset($note[$i])) {
                          break;
