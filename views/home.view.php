            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        <h4 class="mb-3 text-secondary">100% Aunthetic Gadgets</h4>
                        <h1 class="mb-5 display-3 text-primary"> Aunthetic Gadgets & Computer Accessories</h1>
                            ...
                            <ul class="nav nav-pills d-inline-flex text-center mb-5">
                                ...
                                <li class="nav-item">
                                    <a class="d-flex py-2 m-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-2">
                                        <span class="text-dark" style="width: 130px;">Watch</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="d-flex m-2 py-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-3">
                                        <span class="text-dark" style="width: 130px;">Phone</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="d-flex m-2 py-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-5">
                                        <span class="text-dark" style="width: 130px;">airpods</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div id="tab-2" class="tab-pane fade show p-0">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    ...
                                    <?php $note1 = $db->query("SELECT p.id,p.name,p.price,p.image,b.name as brandName,c.name as categoryName  FROM brand b, category c, product p WHERE p.brand_Id=b.id AND p.category_Id=c.id AND c.id='3';")->get();
                                   display(6,$note1);
                                   ?>
                                    </div>
                                </div>
